...
class EmailSender:
    ...
    def __init__(self, config: Config):
        ...
        self._notification_traditional = getattr(config, 'notification_traditional', True)
    ...
    def send_to_email(
        ...
        try:
            ...
            # 繁体化(香港用户):主题与正文统一转繁体(content 可能已在 send() 转过,幂等)
            if self._notification_traditional:
    ...
    def _send_email_with_inline_image(
        ...
        try:
            ...
            if self._notification_traditional:
                from src.utils.zh_convert import to_traditional
                subject = to_traditional(subject)
                plain_alt = to_traditional(plain_alt)
            ...
            alt.attach(MIMEText(plain_alt, 'plain', 'utf-8'))
