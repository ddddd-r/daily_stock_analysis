...
class AgentExecutor:
    ...
    def chat(self, message: str, session_id: str, progress_callback: Optional[Callable] = None, context: Optional[Dict[str, Any]] = None, user_id: Optional[str] = None) -> AgentResult:
        ...
        Args:
            ...
            user_id: Owner of the conversation (for per-user isolation). Falls
                back to DEFAULT_USER_ID when unauthenticated.
